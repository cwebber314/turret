"""
Detect room change (naive implementation).  Compare changes in the camera 
image to the reference image taken on startup.  This will not work for any 
real life situation.  But it is a useful examples
"""
#!/usr/bin/env python
import argparse
import datetime
